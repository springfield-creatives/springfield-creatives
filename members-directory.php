...
<section class="hero overlay" style="background-image: url(media/images/hero.jpg);">
  <article>
    <h1 class="margin text-center">Members Directory</h1>
    <div class="grid grid-center">
      <div class="unit-2-3 unit-1-1-md text-center">
        <p>An intro about how it’s a list of all our members. It’s a great place to find someone to who can help you with your project, or hire them, or just get in touch.</p>
      </div>
    </div>
  </article>
</section>
  ...
  <article>
    <div class="grid small">
      <div class="unit-1-3 unit-1-2-md unit-1-1-sm margin">
        <div class="grid">
          <div class="unit-1-3">
            <p><img class="full rounded" src="media/images/placeholder.png" /></p>
          </div>
          <div class="unit-2-3">
            <h4>Adam Adams</h4>
      ...
      <div class="unit-1-3 unit-1-2-md unit-1-1-sm margin">
        <div class="grid">
          ...
          <div class="unit-2-3">
            <h4>Adam Adams</h4>
            <p>Web Developer<br /><i>Bizzy Business</i><br /><a href="">View Profile</a> |</a> <a href="">Email</a></p>
          </div>
        </div>
      </div>
      <div class="unit-1-3 unit-1-2-md unit-1-1-sm margin">
...
<section class="inverse">
  <article class="text-center">
    ...
    <p class="callout">View the Business Directory for studios, agencies, small shops or organizations that can help you meet your creative goals.</p>
    <p><a class="button" href="">Business Directory</a></p>
  </article>
</section>
