<?php
/**
 * Adds Testimonials_Widget widget.
 */
class Testimonials_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => 'Displays a random Testimonial' ) // Args
		);
	}
...
function register_tests_widget() {
    register_widget( 'Testimonials_Widget' );
}
add_action( 'widgets_init', 'register_tests_widget' );